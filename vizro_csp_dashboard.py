...
if uploaded_file is not None:
    ...
    try:
        ...
        st.info("Using local Excel file: Cloud_Actual_Optimization Data.xlsx")
    except FileNotFoundError:
        st.error("Please upload your Excel file or ensure 'Cloud_Actual_Optimization Data.xlsx' is in the repository.")
        st.stop()
...
try:
    ...
    st.write("Please check that your Excel file has the correct format and sheet structure.")
